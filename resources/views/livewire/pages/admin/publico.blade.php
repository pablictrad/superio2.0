...
class extends Component
{
    ...
    public function llamados()
    {
        ...
        $cargosPorLlamado = DB::table('nuevo_cargo_por_llamado')
            ...
            ->join('tb_turnos', 'nuevo_rel_carrera_cargo.turno_id', '=', 'tb_turnos.id')
            ->join('tb_perfil', 'nuevo_rel_carrera_cargo.perfil_id', '=', 'tb_perfil.idtb_perfil')
                        ...
                        <td class="px-1 py-4 align-top text-center overflow-hidden">
                            ...
                            <div class="inline-block bg-indigo-100 text-indigo-800 text-[10px] font-black px-1 rounded uppercase tracking-tighter mb-1">
                               ...
                               <div class="mt-3 mb-2 text-center">
                                    ...
                                    @else
                                    hora_catedra`    <span class="bg-red-200 text-red-600 px-2 py-1 rounded-full text-[10px] font-black uppercase border border-red-100">Cerrado</span>
                                    @endif
                                </div>  
                                    ...
                                    <div class="min-h-[120px] border-b border-gray-100 pb-2 mb-2">
                                        ...
                                        <div class="mt-2 text-xs text-gray-500 space-y-1">
                                            ...
                                            <div>
                                                ...
                                                <span class="font-bold ml-2">Turno:</span>
                                                {{ $det->turno }}
                                            </div>
