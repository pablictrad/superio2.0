...
class RelCarreraCargo extends Model
{
    protected $table = 'nuevo_rel_carrera_cargo';
    public $timestamps = false;
    protected $fillable = ['carrera_id', 'cargo_id', 'turno_id', 'periodo_id', 'perfil_id', 'hora_catedra', 'anio','instituto_id'];
